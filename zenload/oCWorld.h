...
namespace ZenLoad
{
    ...
    public:
        ...
        static size_t readVobTree(ZenParser &parser,
                                  std::vector<zCVobData> &target,
        ...
        /**
         * @brief readObjectData reads this object from an internal zen
         * @param info oCWorldData info object.
         * @param parser ZenParser.
         * @param versionInternal a version.
         */
        static void readObjectData(oCWorldData &info,
                                   ZenParser &parser,
                                   uint32_t versionInternal)
        {
