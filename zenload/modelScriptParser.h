...
namespace ZenLoad
{
    ...
    public:
        ...
        /**
         * @brief ani returns the parsed animation alias.
        ...
        /**
         * @brief alias returns the parsed animation alias.
        ...
        /**
         * @brief sfx returns the sfx event.
        ...
        /**
         * @brief parse reads the next chunk.
    ...
    /**
     * @brief The ModelScriptBinParser class a streaming parser for .MSB files.
     */
    ...
    /**
     * @brief The ModelScriptTextParser class is a streaming parser for .MDS files.
     */
